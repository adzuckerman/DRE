({
  doInit: function(component, event, helper) {
    ...
    helper.applyBillableDefault(component, event, helper);
    helper.applyTypeFieldInfo(component, event, helper);
  },
  ...
  addTimeItem: function(component) {
    ...
    $A.createComponent('TASKRAY:trTaskTypeahead', {}, function(newComponent) {
  ...
  saveClicked: function(component, event, helper) {
    ...
    var isBillable = component.find('billableCheckbox').getElement().checked;
    var timeType;
    if (component.get('v.showTypeField') == true) {
      timeType = component.get('v.selectedTimeType');
    }
    if (!taskId) {
      return;
    }
    var action = component.get('c.addDetailedTimeEntriesToTaskFromTimesheet');
    action.setParams({
  ...
  billableToggle: function(component, event, helper) {
    component.set('v.billable', component.get('v.billable'));
  }
});